...
import TableHeader from "@components/globals/TableHeader";
import BookingsTableBody from "@components/venues/bookings/BookingsTableBody";
  ...
  return (
    <div className='max-w-5xl mx-auto mt-10 p-4 bg-white shadow-lg rounded-lg'>
      <h1 className='text-xl font-semibold text-gray-800'>
        Customers bookings for this venue
      </h1>
